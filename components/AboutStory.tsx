    ...
    <div className="relative overflow-hidden bg-white py-16">
      ...
      <div className="relative px-4 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-prose text-lg">
          <h1>
            <span className="block text-center text-lg font-semibold text-main-600">
              Our Story
            </span>
        ...
        <div className="prose prose-lg prose-main mx-auto mt-6 text-gray-500">
          <p>
          ...
          <p>
            Faucibus commodo rhoncus, volutpat. Dignissim sed eget risus enim.
            Mattis mauris semper sed amet vitae sed turpis id. Id praesent donec
            est. Odio penatibus risus viverra tellus varius sit neque erat
            velit.
          </p>
        </div>
      </div>
